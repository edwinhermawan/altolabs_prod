$(document).ready(function () {
    ...
    function getCvc() {
        ...
        $(this).animate({'marginLeft': '-=25%'}, 200, 'swing', function () {
            ...
            $this.inputmask("99999", {placeholder: " ", "oncomplete": getZipCode});
    ...
    function getExpDate() {
        ...
        var $this = $(this),
            cardExpObj = $.payment.cardExpiryVal($this.val()),
            valid = $.payment.validateCardExpiry(cardExpObj.month, cardExpObj.year);
        if (valid) {
            ...
            $this.animate({'marginLeft': '-=25%'}, 200, 'swing', function () {
                var $thisInner = $(this);
                $thisInner.val('');
                $thisInner.css('margin-left', '0px');
                $thisInner.css('width', '83.33%');
                // Clear out expDate and put in clean cvc
                $thisInner.closest('div').siblings('label').text("CVC");
                $thisInner.closest('div').siblings('.card-type').css('background-image', 'url(data:image/svg+xml;base64,)');
                $thisInner.inputmask(cvvMask, {placeholder: " ", "oncomplete": getCvc});
                $thisInner.attr('placeholder', 'CVC');
            });
        } else {
    ...
    function getCardNumber() {
        var valid = $.payment.validateCardNumber(this.value);
        if (valid) {
            var cardArray = {},
    ...
    var amexCheck = function () {
            var $this = $(this);
            if ($.trim(this._valueGet()).substring(0, 2) === "37" && $.trim(this._valueGet()).length === 2) {
                console.log("This is an AMEX card");
                $this.inputmask("9999 9999 9999 999", {placeholder: " ", "oncomplete": getCardNumber, "onKeyUp": amexCheck});
                cvvMask = "9999";
            } else {
                if ($.trim(this._valueGet()).length === 2) {
                    $this.inputmask("9999 9999 9999 9999", {placeholder: " ", "oncomplete": getCardNumber, "onKeyUp": amexCheck, 'autoUnmask': true});
                }
            }
        };

    $(document.body).on("focus.#newCardNumber.mask", "#newCardNumber, .testId", function (e) {
        e.preventDefault();
        ...
        if (!data._inputmask) {
            element.inputmask("9999 9999 9999 9999", {placeholder: " ", "oncomplete": getCardNumber, "onKeyUp": amexCheck, 'autoUnmask': true });
        }
    });

    // User can edit Card Number, ExpDate, and CVC numbers inline after they input them
    var replaceWith = $('<input name="temp" type="text" class="testId"/>');
