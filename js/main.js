$(function() {
  ...
  $("#newCardNumber").inputmask("9999 9999 9999 9999", {placeholder: " ", "oncomplete": getCardNumber, 'autoUnmask' : true
  } );

  // Account for Amex card numbers (15 digits and starts with 37)
  // $("#newCardNumber").on('keypress', function(){
  //   console.log($(this).val().length);
  //   if($(this).val().length==18 && $(this).substring(0, 1) == "37"){
  //     getCardNumber.apply(this);
  //   }
  // })
  var cvvMask = "999"
  $('#newCardNumber').on('keypress', function(){
    if ($(this).val().substring(0,2)=="37"){
      ...
      $(this).off('keypress');
      $(this).inputmask("9999 9999 9999 999", {placeholder: " ", "oncomplete": getCardNumber
      });
      cvvMask="9999";
    }
    // } else {
    ...
    //     $(this).off('keypress');
    //     $(this).inputmask("9999 9999 9999 9999", {placeholder: " ", "oncomplete": getCardNumber})
    //   }
    // }
  })
